...
//    productDictList = [[ArcosCoreData sharedArcosCoreData].arcosCoreDataManager processPriceProductList:productDictList priceHashMap:priceHashMap];
    productDictList = [[ArcosCoreData sharedArcosCoreData] processEntryPriceProductList:productDictList productIURList:productIURList locationIUR:[GlobalSharedClass shared].currentSelectedLocationIUR packageIUR:[[GlobalSharedClass shared] retrieveCurrentSelectedPackageIURWithRequestSource:ProductRequestSourceDefault]];
    ...
    for (int i = 0; i < [keyList count]; i++) {
        ...
        [tempDict setObject:[NSNumber numberWithFloat:[ArcosUtils roundFloatThreeDecimal:[[tempDict objectForKey:@"LineValue"] floatValue]]] forKey:@"LineValue"];
