...
@interface ArcosCalendarEventEntryDetailTableViewController : UITableViewController <ArcosCalendarEventEntryDetailBaseTableViewCellDelegate>{
    id<ArcosCalendarEventEntryDetailTableViewControllerDelegate> _refreshDelegate;
...
@property(nonatomic, assign) id<ArcosCalendarEventEntryDetailTableViewControllerDelegate> refreshDelegate;
