//
//  ProductDetailStockTableViewController.h
//  Arcos
//
...
@interface ProductDetailStockTableViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate> {
