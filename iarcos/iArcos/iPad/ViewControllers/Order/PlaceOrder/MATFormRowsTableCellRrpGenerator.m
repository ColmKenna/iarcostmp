//
//  MATFormRowsTableCellRrpGenerator.m
//  iArcos
//
...
@implementation MATFormRowsTableCellRrpGenerator

- (MATFormRowsTableCell*)generateTableCellWithTableView:(UITableView*)aTableView {
    NSString* CellIdentifier = @"IdRrpMATFormRowsTableCell";
...
- (UIView*)generateTableHeaderView {
    ...
    for (id nibItem in nibContents) {
        if ([nibItem isKindOfClass:[UIView class]] && [(UIView*)nibItem tag] == 52) {
