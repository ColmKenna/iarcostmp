//
//  CustomerSurveyLoadAnswerDataManager.m
//  iArcos
//
...
@implementation CustomerSurveyLoadAnswerDataManager
...
- (NSMutableArray*)retrieveResponseWithLocationIUR:(NSNumber*)aLocationIUR surveyIUR:(NSNumber*)aSurveyIUR contactIUR:(NSNumber*)aContactIUR questionIURList:(NSMutableArray*)aQuestionIURList {
    return [[ArcosCoreData sharedArcosCoreData] responseWithLocationIUR:aLocationIUR surveyIUR:aSurveyIUR contactIUR:aContactIUR questionIURList:aQuestionIURList unsendOnly:NO];
}
...
- (void)manipulateResponseWithDataList:(NSMutableDictionary*)aQuestionDict originalDataDict:(NSMutableDictionary*)anOriginalQuestionDict contactIUR:(NSNumber*)aContactIUR locationIUR:(NSNumber*)aLocationIUR {
    [[ArcosCoreData sharedArcosCoreData] insertResponseWithDataList:aQuestionDict originalDataDict:anOriginalQuestionDict contactIUR:aContactIUR locationIUR:aLocationIUR unsendOnly:NO];
}
