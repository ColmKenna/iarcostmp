//
//  QueryOrderMemoStringViewTableCell.m
//  Arcos
//
...
#import "QueryOrderMemoStringViewTableCell.h"

@implementation QueryOrderMemoStringViewTableCell
@synthesize fieldDesc = _fieldDesc;
@synthesize contentString = _contentString;
@synthesize isMaxCalculated = _isMaxCalculated;
...
//    if (!self.isMaxCalculated) {
//        self.isMaxCalculated = YES;
//        if ([[self.delegate getFieldNameWithIndexPath:self.indexPath] isEqualToString:@"Details"]) {
//            self.maximum = 4000;
//        } else {
//            self.maximum = 150;
//        }
