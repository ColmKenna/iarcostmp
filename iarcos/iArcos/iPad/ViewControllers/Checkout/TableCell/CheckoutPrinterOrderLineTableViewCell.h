//
//  CheckoutPrinterOrderLineTableViewCell.h
//  iArcos
//
...
@interface CheckoutPrinterOrderLineTableViewCell : UITableViewCell {
    UILabel* _productCodeOrderPadDetails;
...
@property(nonatomic, retain) IBOutlet UILabel* productCodeOrderPadDetails;
