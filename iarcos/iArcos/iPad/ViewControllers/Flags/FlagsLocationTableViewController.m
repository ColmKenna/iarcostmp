//
//  FlagsLocationTableViewController.m
//  iArcos
//
...
@interface FlagsLocationTableViewController ()

@end

@implementation FlagsLocationTableViewController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (!self.viewHasBeenAppearedFlag) {
        [self scrollBehindSearchSection];
        self.viewHasBeenAppearedFlag = YES;
    }
}
...
- (void)allPressed:(id)sender {
    [self.selectionDelegate didSelectFlagsLocationRecord:self.allLocationRecordDict];
}
