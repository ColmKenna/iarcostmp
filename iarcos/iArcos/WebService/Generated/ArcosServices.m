...
+(ArcosServices*)service{
	return (ArcosServices*)[[[ArcosServices alloc] init] autorelease];
}

+(ArcosServices*)serviceWithServer:(NSString*)serverName{
	return (ArcosServices*)[[[ArcosServices alloc] initWithServer:serverName] autorelease];
}
